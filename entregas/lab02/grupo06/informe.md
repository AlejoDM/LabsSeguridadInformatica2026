...
6. **Noviembre 2013:** Investigadores criptográficos confirman el mal uso de 3DES en modo ECB sin sal (*salt*) y el almacenamiento de pistas en texto plano [6].
...
*(A completar por el integrante asignado)*
...
`hmac.compare_digest()` se utiliza para reducir el riesgo de ataques de temporización o *timing attacks* durante la verificación de un MAC.
